...
export default function Footer(): React.ReactElement {
  const handleLinkClick = (linkLabel: string): void => {
    if (typeof window !== "undefined" && (window as Window & { trackEvent?: (name: string, params: Record<string, string>) => void }).trackEvent) {
      (window as Window & { trackEvent: (name: string, params: Record<string, string>) => void }).trackEvent("footer_link_click", { link: linkLabel });
    }
  };
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-xs">
              Automated price tracking for e-commerce. Stay competitive
              effortlessly with real-time competitor price monitoring.
            </p>
            {/* Social Links */}
            <div className="flex space-x-4">
              ...
              <a
                href="https://github.com/INDEX-prog/pricehawk"
                className="w-10 h-10 bg-slate-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
                aria-label="GitHub"
              >
                <svg
